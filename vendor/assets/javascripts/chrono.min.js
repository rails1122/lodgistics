!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var o;"undefined"!=typeof window?o=window:"undefined"!=typeof global?o=global:"undefined"!=typeof self&&(o=self),o.chrono=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
    ...
    var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)([0-9]{4})\\-([0-9]{1,2})\\-([0-9]{1,2})(?:T([0-9]{1,2}):([0-9]{1,2})(?::([0-9]{1,2})(?:\\.(\\d{1,4}))?)?(?:Z|([+-]\\d{2}):?(\\d{2})?)?)?(?=\\W|$)","i"),YEAR_NUMBER_GROUP=2,MONTH_NUMBER_GROUP=3,DATE_NUMBER_GROUP=4,HOUR_NUMBER_GROUP=5,MINUTE_NUMBER_GROUP=6,SECOND_NUMBER_GROUP=7,MILLISECOND_NUMBER_GROUP=8,TZD_HOUR_OFFSET_GROUP=9,TZD_MINUTE_OFFSET_GROUP=10;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,s,e,r){var t=e[0].substr(e[1]),a=e.index+e[1].length,n=new ParsedResult({text:t,index:a,ref:s});if(n.start.assign("year",parseInt(e[YEAR_NUMBER_GROUP])),n.start.assign("month",parseInt(e[MONTH_NUMBER_GROUP])),n.start.assign("day",parseInt(e[DATE_NUMBER_GROUP])),moment(n.start.get("month"))>12||moment(n.start.get("month"))<1||moment(n.start.get("day"))>31||moment(n.start.get("day"))<1)return null;if(null!=e[HOUR_NUMBER_GROUP])if(n.start.assign("hour",parseInt(e[HOUR_NUMBER_GROUP])),n.start.assign("minute",parseInt(e[MINUTE_NUMBER_GROUP])),null!=e[SECOND_NUMBER_GROUP]&&n.start.assign("second",parseInt(e[SECOND_NUMBER_GROUP])),null!=e[MILLISECOND_NUMBER_GROUP]&&n.start.assign("millisecond",parseInt(e[MILLISECOND_NUMBER_GROUP])),null==e[TZD_HOUR_OFFSET_GROUP])n.start.assign("timezoneOffset",0);else{var R=0,_=parseInt(e[TZD_HOUR_OFFSET_GROUP]);null!=e[TZD_MINUTE_OFFSET_GROUP]&&(R=parseInt(e[TZD_MINUTE_OFFSET_GROUP]));var U=60*_;0>U?U-=R:U+=R,n.start.assign("timezoneOffset",U)}return n.tags.ENISOFormatParser=!0,n}};
    ...
    var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)((?:sun|mon|tues?|wed(?:nes)?|thu(?:rs?)?|fri|sat(?:ur)?)(?:day)?)?\\s*\\,?\\s*([0-9]{1,2})[\\/\\.\\-]([0-9]{1,2})([\\/\\.\\-]([0-9]{4}|[0-9]{2}))?(\\W|$)","i"),DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,wednesday:3,wed:3,thursday:4,thur:4,friday:5,fri:5,saturday:6,sat:6};exports.Parser=function(e){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,r,t,s){if("/"==t[1]||"/"==t[7])return void(t.index+=t[0].length);var a=t.index+t[1].length,e=t[0].substr(t[1].length,t[0].length-t[7].length),n=new ParsedResult({text:e,index:a,ref:r});if(!e.match(/^\d.\d$/)&&(t[6]||!(t[0].indexOf("/")<0))){var u=t[6]||moment(r).year()+"",i=t[3],d=t[4];if(i=parseInt(i),d=parseInt(d),u=parseInt(u),(1>i||i>12)&&i>12){if(!(d>=1&&12>=d&&i>=13&&31>=i))return null;var l=i;i=d,d=l}return 1>d||d>31?null:(100>u&&(u>50?u=u+2500-543:u+=2e3),n.start.assign("day",d),n.start.assign("month",i),n.start.assign("year",u),t[2]&&n.start.assign("weekday",DAYS_OFFSET[t[2].toLowerCase()]),n.tags.ENSlashDateFormatParser=!0,n)}}};
    ...
    function Parser(t){this.isStrictMode=function(){return 1==t},this.pattern=function(){return/./i},this.extract=function(t,e,r,n){return null},this.execute=function(t,e,r){for(var n=[],i=this.pattern(),s=t,h=i.exec(s);h;){h.index+=t.length-s.length;var u=this.extract(t,e,h,r);u?(s=t.substring(u.index+u.text.length),(!this.isStrictMode()||u.hasPossibleDates())&&n.push(u)):s=t.substring(h.index+1),h=i.exec(s)}return this.refiners&&this.refiners.forEach(function(){n=refiner.refine(n,t,options)}),n}}exports.Parser=Parser;
